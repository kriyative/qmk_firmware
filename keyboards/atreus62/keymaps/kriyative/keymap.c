...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DEFAULT] = LAYOUT( /* qwerty */
    ...
    KC_ESC,  KC_F24,  KC_LGUI, KC_LCTRL,FN,      KC_LALT,  KC_BSPC, KC_SPC,   KC_RCTRL,FN,      KC_RALT, KC_RGUI, KC_EQL,  KC_ENT
  ),
 ...
 TO(_RESET), KC_F24,  KC_LGUI, KC_LCTRL,_______, KC_LALT,KC_BSPC, KC_SPC,   KC_RCTRL,_______, KC_RALT, KC_RGUI, _______, KC_PGDN
  ),
